...
function normalizeString(str) {
    ...
    normalized = normalized.replace(/[\u30A1-\u30FF]/g, function (char) {
...
function Main(){
    ...
    let [initialMusics, setFirstMusics] = useState([]);
    ...
    useEffect(() =>{
        console.log(auth);
        if(auth){
            fetch(`${apiUrl}/api/music/user-music/${auth.username}/`)
